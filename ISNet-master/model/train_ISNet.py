...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        for i, (data, labels, edge) in enumerate(tbar):
            ...
            # The gradient magnitude can be sqrt(2) at diagonal mask corners.
            # BCELoss requires targets in [0, 1], so normalize its target range.
            edge_gt = self.gradmask(edge.cuda()).clamp_(0.0, 1.0)
