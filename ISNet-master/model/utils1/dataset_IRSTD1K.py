...
class SirstDataset(Data.Dataset):
    ...
    def __init__(self, args, mode='train'):
        ...
        # Resolve the dataset relative to the repository instead of using the
        # author's Linux-only absolute path.  This works on Windows and Linux.
        base_dir = osp.abspath(osp.join(osp.dirname(__file__), '..', '..', 'IRSTD-1k'))
