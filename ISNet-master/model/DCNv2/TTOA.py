...
# Support importing this file as part of the DCNv2 package (the normal
# ``from DCNv2.TTOA import TTOA`` path) as well as the original standalone
# script-style import used by the upstream code.
try:
